...
const (
	...
	defaultPreDeflationaryPhaseBaseSubsidy         = 1 * constants.SompiPerKaspa
	defaultDeflationaryPhaseBaseSubsidy            = 1 * constants.SompiPerKaspa
	...
	defaultDeflationaryPhaseDaaScore = 3942660
