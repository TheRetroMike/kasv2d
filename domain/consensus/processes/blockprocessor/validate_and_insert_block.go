...
import (
	...
	"github.com/kasv2/kasv2d/domain/consensus/utils/multiset"
	"github.com/kasv2/kasv2d/domain/consensus/utils/utxo"
	"github.com/kasv2/kasv2d/infrastructure/db/database"
	"github.com/kasv2/kasv2d/infrastructure/logger"
	"github.com/kasv2/kasv2d/util/difficulty"
...
func (bp *blockProcessor) loadUTXODataForGenesis(stagingArea *model.StagingArea, block *externalapi.DomainBlock) {
	...
	// found here for anyone to verify: https://github.com/kasv2/kasv2d/blob/dbf18d8052f000ba0079be9e79b2d6f5a98b74ca/domain/consensus/processes/blockprocessor/resources/utxos.gz
