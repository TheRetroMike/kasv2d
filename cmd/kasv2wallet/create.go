...
import (
	...
	"github.com/kaspanet/kaspad/cmd/kasv2wallet/libkaspawallet"
	"github.com/kaspanet/kaspad/cmd/kasv2wallet/libkaspawallet/bip32"
	"github.com/kaspanet/kaspad/cmd/kasv2wallet/utils"
	"github.com/pkg/errors"

	"github.com/kaspanet/kaspad/cmd/kasv2wallet/keys"
)
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"kasv2wallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"kasv2wallet new-address\" to create and see one)\n\n")
