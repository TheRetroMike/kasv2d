...
const (
	defaultConfigFilename      = "kasv2d.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "kasv2d.log"
	defaultErrLogFilename      = "kasv2d_err.log"
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 22211, testnet: 16211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 22210, testnet: 16210)"`
